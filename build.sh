...
IMAGES2="kube-cross echoserver heapster heapster_influxdb heapster_grafana defaultbackend nginx-ingress-controller addon-resizer etcd-amd64 cluster-autoscaler kube-state-metrics kube-registry-proxy mongodb-install spark zeppelin spartakus-amd64"
